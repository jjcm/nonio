...
export default class NonioVideoUploader extends NonioComponent {
  constructor() {
    super()
  }
  ...
  html(){ return `
    ...
    <div id="encoding">
      <nonio-encoding-progress></nonio-encoding-progress>
    </div>
  `}
  ...
  async encode(filename){
    ...
    const getEncodingProgress = () => {
      return this.select('nonio-encoding-progress')
    }
