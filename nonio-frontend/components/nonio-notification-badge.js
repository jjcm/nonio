...
export default class NonioNotificationBadge extends NonioComponent {
  constructor() {
    super()
  }
  ...
  css(){
    return `
      ...
      nonio-link { display: contents; }
    `
  }

  html(){ return `
    <nonio-link href="/notifications" fresh>
      ${NonioIcon?.icon('mail', 16)}
      <span></span>
    </nonio-link>
  `}
