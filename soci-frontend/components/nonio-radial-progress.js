...
export default class NonioRadialProgress extends NonioComponent {
  constructor() {
    super()
  }
  ...
  css() { return `
    ...
    svg {
      ...
      transition: stroke-dashoffset var(--transition-speed) linear, stroke 0.3s var(--nonio-ease-out) calc(var(--transition-speed) - 0.1s);
      height: 24px;
      width: 24px;
    }
    ...
    path { 
      ...
      transition: stroke-dashoffset 0.3s var(--nonio-ease-out);
    }
    ...
    :host([percent="100"]) path {
      ...
      transition: stroke-dashoffset 0.3s var(--nonio-ease-out) calc(var(--transition-speed) - 0.1s);
    }
  `}
