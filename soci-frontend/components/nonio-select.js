...
export class NonioSelect extends NonioComponent {
  constructor() {
    super()
  }
  ...
  get value() {
    let option = this.querySelector('nonio-option[slot="selected"]')
...
export class NonioOption extends NonioComponent {
  constructor() {
    super()
  }
