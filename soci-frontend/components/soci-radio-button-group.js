...
export default class SociRadioButtonGroup extends SociComponent {
  constructor() {
    super()
  }
  ...
  connectedCallback() {
    ...
    this.addEventListener('soci-radio-select', this._onSelect)
  ...
  disconnectedCallback() {
    this.removeEventListener('soci-radio-select', this._onSelect)
  ...
  get _buttons() {
    return Array.from(this.querySelectorAll('soci-radio-button'))
  }
