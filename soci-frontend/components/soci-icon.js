...
const icons = {
  ...
  ,playFilled: { viewBox: '0 0 16 16', body: '<path d="M12 8L6 4.8V11.2L12 8Z" fill="currentColor" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>' }
  ,close: { viewBox: '0 0 16 16', body: '<path d="M4.5 4.5L11.5 11.5M11.5 4.5L4.5 11.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none"/>' }
