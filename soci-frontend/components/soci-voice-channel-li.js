...
export default class SociVoiceChannelLi extends SociComponent {
  constructor() {
    super()
  }
  ...
  css(){
    return `
      ...
      #participants ::slotted(soci-user) {
        display: block;
        margin-bottom: 6px;
        --font-size: 14px;
        --font-weight: 500;
      ...
      #participants ::slotted(soci-user:last-child) {
        margin-bottom: 0;
      }
  ...
  html(){
    return `
      <button type="button" class="channel-row" id="channel-row">
        <span class="icon-wrapper"><soci-icon glyph="volume" size="16"></soci-icon></span>
